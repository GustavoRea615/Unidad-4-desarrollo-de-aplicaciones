 ...
 */
public class EncendidoLago extends ControlLago {
    @Override
    public void presionarSwitch(Lago lago, Canvas canvas) {
        lago.setEstado(new ApagadoLago());
        ...
        path5.moveTo(50, 225);//1
        path5.lineTo(50, 400);//2
        path5.lineTo(500, 400);//3
        path5.lineTo(500, 225);//4
        path5.lineTo(50, 225);//5
