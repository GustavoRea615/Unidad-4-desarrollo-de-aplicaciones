...
import utng.edu.mx.ordersrea.adapters.ProductAdapter;
...
public class ProductActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    case R.id.bt_edit_product:
                        ...
                        if (c!=null){
                            if (c.moveToFirst()){
                                product = new Product(c.getString(1),c.getString(2),c.getFloat(3),c.getInt(4));
                            }
        ...
        btSaveProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!product.getIdProduct().equals("")){
                    ...
                    product = new Product("", etName.getText().toString(), Float.parseFloat(etPrice.getText().toString()), Integer.parseInt(etStock.getText().toString()));
    ...
    private void getProducts(){
        ...
        if(c!=null){
            while (c.moveToNext()){
                products.add(new Product(c.getString(1),c.getString(2),c.getFloat(3),c.getInt(4)));
            }
        }
