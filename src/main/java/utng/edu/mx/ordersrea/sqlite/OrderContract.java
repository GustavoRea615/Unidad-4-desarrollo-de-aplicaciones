...
public class OrderContract {
    ...
    public static class Products implements ProductColumns{
        public static String generateIdProduct(){ return  "PR-"+ UUID.randomUUID().toString();
        }
    }

    public static class Cardboxes implements CardboxColumns{
        public static String generateIdCardbox(){
